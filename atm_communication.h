...
/**
* @brief Klasa komunikacji z bankiem
*
* Odpowiedzialna za wykonywanie polaczen z bankiem nakazanych przez atm_service
*/
class atm_communication : public Thread
{
  ...
  public:
	...
	/**
	 * Metoda do przeslania danych do banku na podany adres IP.
	 *
